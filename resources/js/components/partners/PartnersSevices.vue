    ...
    <div class="bg-white position-relative">
        <div id="servicesPartners">
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        <h3 class="text-center title-border-bottom">
                            {{$store.getters.getTags({tag:'partners_text2'})}}</h3>
                    </div>
                    <div class="col-12">
        ...
        <img class="img-float-1  d-none d-md-inline-block" src="/images/iconos/circulogrueso.svg"
